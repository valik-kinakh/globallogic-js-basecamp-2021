    ...
    return(
        <div id={"rightBar"}>
           <h1>Valentyn Kinakh</h1>
            <div id={"text"}><p>I am a first year student at Ivan Franko National University. I am keen on programing and coding. I enjoy using my contribute to the existing technological advances. I have excellent communication skills, enabling me to effectively communicate with a wide range of people. I am seeing a part-time position in the industry in which I can put into practice my knowledge and experience, ultimately benefiting the operations of the organisation that I work for.</p>
            </div>
            <br/>
            <br/>
         <p style={{color:'grey'}}>____________________________________________________________________________________________________________________</p>
            <br/>
            <h4 style={{
                letterSpacing:1.5,
                color:"#23a8a8",
