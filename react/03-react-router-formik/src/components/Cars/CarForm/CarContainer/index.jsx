...
function CarContainer({ initialValues, onSubmit, mode, gearboxes, required }) {
  return (
    <Formik initialValues={initialValues} onSubmit={onSubmit}>
      <Form>
        <div className={'form'}>
          <Input name={NAME} label='Name' disabled={mode === MODE.VIEW} required={required}
                 validate={value => {
                   if (value.trim() === '') {
          ...
          />
          <Input name={MODEL} label='Model' disabled={mode === MODE.VIEW} required={required}
                 validate={value => {
                   if (value.trim() === '') {
          ...
          />
          <Select name={GEARBOX} label='Gearbox' disabled={mode === MODE.VIEW} value={gearboxes}
                  validate={value => {
                    if (!value) {
